...
# 0. 공통 설정 & 폰트
# -----------------------------------------------------------
st.set_page_config(page_title="메리츠 보고 자동화 V11.0", layout="wide")
...
# -----------------------------------------------------------
# MODE 1: V6.6 Legacy (Original Code Preservation)
# -----------------------------------------------------------
def run_v6_6_legacy():
    # 리더님이 주신 오리지널 코드 (V4.1 기반) 그대로 삽입
    # (약간의 들여쓰기 조정만 적용)
